      ...
      <div className="flex flex-col items-center justify-center gap-y-8 relative">
        <Container className="hidden lg:flex absolute inset-0 top-0 mb-auto flex-col items-center justify-center w-full min-h-screen -z-10">
          <OrbitingCircles speed={0.5} radius={300}>
            <Icons.circle1 className="size-4 text-blue-500/70" />
            <Icons.circle2 className="size-1 text-blue-500/80" />
          </OrbitingCircles>
          <OrbitingCircles speed={0.25} radius={400}>
            <Icons.circle2 className="size-1 text-blue-500/50" />
            <Icons.circle1 className="size-4 text-blue-500/60" />
            <Icons.circle2 className="size-1 text-blue-500/90" />
          </OrbitingCircles>
        ...
        <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-white">
          ...
          <Container delay={0.3} className="relative">
            ...
            <div className="bg-gradient-to-t from-blue-600 to-transparent absolute bottom-0 inset-x-0 w-full h-1/2"></div>
          </Container>
        </div>
      </div>
    </div>
