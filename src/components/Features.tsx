        ...
        <div className="flex flex-col items-center gap-5 lg:gap-5 w-full">
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_.65fr] w-full gap-5 lg:gap-5">
              <MagicCard className="flex flex-col items-start size-full bg-primary/[0.08]">
              ...
              <MagicCard className="flex flex-col items-start w-full bg-primary/[0.08]">
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-3 w-full gap-5 lg:gap-5">
              <MagicCard className="flex flex-col items-start w-full row-span-1 bg-primary/[0.08]">
                <div className="bento-card w-full flex-row gap-6">
              ...
              <div className="grid grid-rows gap-5 lg:gap-5">
                <MagicCard className="flex flex-col items-start w-full row-span- row-start-[0.5] h-32 bg-primary/[0.08]">
                ...
                <MagicCard className="flex flex-col items-start w-full row-start-2 !h-max bg-primary/[0.08]">
